...
`;
    ...
    const generateBudget = async () => {
      try {
        const genAI = new GoogleGenerativeAI(
          'AIzaSyAo10fjVMqr93tIi4phy6fIrEtJgteqCLA'
        );
  ...
  const getUserdata = async () => {
    try {
      const response = await axios.get(
        `http://localhost:8000/api/auth/users/${userId}/full-data`
      );
  ...
  const getOwedData = async () => {
    try {
      const response = await axios.post(
        'http://localhost:8000/api/splits/getspiltdata',
        { userId }
      );
  ...
  const getSplits = async () => {
    try {
      const response = await axios.get(
        `http://localhost:8000/api/splits/user/${userId}`
      );
  ...
  const getAllExpenses = async () => {
    try {
      const response = await axios.post(
        'http://localhost:8000/api/transaction/getallexpense',
        { userId }
      );
  ...
  const getNavbarData = async () => {
    try {
      const response = await axios.post(
        'http://localhost:8000/api/transaction/getdata',
        { userId }
      );
  ...
  const getAllIncomes = async () => {
    try {
      const response = await axios.post(
        'http://localhost:8000/api/transaction/getallincome',
        { userId }
      );
