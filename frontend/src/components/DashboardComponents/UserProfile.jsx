      ...
      <div className="pt-16 px-6 pb-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="flex-1 bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md flex items-center justify-center transition-colors"
          >
            Add Income
          </button>
          ...
          <button
            ...
            className="flex-1 bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded-md flex items-center justify-center transition-colors"
          >
            LogOut
          </button>
        </div>
